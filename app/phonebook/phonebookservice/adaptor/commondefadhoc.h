#ifndef COMMON_DEF_ADHOC_H
#define COMMON_DEF_ADHOC_H
...
Q_DECLARE_METATYPE(QT_DTT_ADHOC::UserInfo)

inline QDBusArgument &operator<<(QDBusArgument &argument, const QT_DTT_ADHOC::UserInfo &user)
{
...
inline const QDBusArgument &operator>>(const QDBusArgument &argument, QT_DTT_ADHOC::UserInfo &user)
{
    argument.beginStructure();
    argument >> user.userId >> user.network >> user.addr >> user.appId >> user.optId >> user.userName
        >> user.lte_ip >> user.lte_pocId >> user.ad_hoc_ip >> user.satellite_ip >> user.satellite_phone_number
...
inline QDataStream &operator<<(QDataStream &out, const QT_DTT_ADHOC::UserInfo &user)
{
...
inline QDataStream &operator>>(QDataStream &in, QT_DTT_ADHOC::UserInfo &user)
{
...
Q_DECLARE_METATYPE(QT_DTT_ADHOC::HandlerData)

inline QDBusArgument &operator<<(QDBusArgument &argument, const QT_DTT_ADHOC::HandlerData &data)
{
    argument.beginStructure();
...
inline const QDBusArgument &operator>>(const QDBusArgument &argument, QT_DTT_ADHOC::HandlerData &data)
{
    argument.beginStructure();
    argument >> data.network >> data.dialState >> data.dialNum >> data.start >> data.end >> data.isMetting >> data.mettingTarget;
    argument.endStructure();
...
Q_DECLARE_METATYPE(QT_DTT_ADHOC::GroupInfo)

inline QDBusArgument &operator<<(QDBusArgument &argument, const QT_DTT_ADHOC::GroupInfo &group)
{
    argument.beginStructure();
...
inline const QDBusArgument &operator>>(const QDBusArgument &argument, QT_DTT_ADHOC::GroupInfo &group)
{
    QT_DTT_ADHOC::UserInfo user;
    argument.beginStructure();
    argument >> group.id >> group.network >> group.addr;
    argument >> group.name >> group.creator >> group.admin >> group.admins >> group.priority >> group.memberSize;
    argument >> group.croomid >> group.sessionIndex >> group.baseMembers;
...
inline QDataStream &operator<<(QDataStream &out, const QT_DTT_ADHOC::GroupInfo &group)
{
...
inline QDataStream &operator>>(QDataStream &in, QT_DTT_ADHOC::GroupInfo &group)
{
    QT_DTT_ADHOC::UserInfo user;
...
Q_DECLARE_METATYPE(QT_DTT_ADHOC::GroupTransMsg)

inline QDBusArgument &operator<<(QDBusArgument &argument, const QT_DTT_ADHOC::GroupTransMsg &groupmsg)
{
    argument.beginStructure();
...
inline const QDBusArgument &operator>>(const QDBusArgument &argument, QT_DTT_ADHOC::GroupTransMsg &groupmsg)
{
    QT_DTT_ADHOC::UserInfo user;
    argument.beginStructure();
    argument >> groupmsg.id >> groupmsg.ipocId  >> groupmsg.groupId >> groupmsg.name >> groupmsg.description;
...
inline QDataStream &operator<<(QDataStream &out, QT_DTT_ADHOC::GroupTransMsg &groupmsg)
{
...
inline QDataStream &operator>>(QDataStream &in, QT_DTT_ADHOC::GroupTransMsg &groupmsg)
{
...
Q_DECLARE_METATYPE(QT_DTT_ADHOC::MessageInfo)

inline QDBusArgument &operator<<(QDBusArgument &argument, const QT_DTT_ADHOC::MessageInfo &info)
{
    argument.beginStructure();
...
inline const QDBusArgument &operator>>(const QDBusArgument &argument, QT_DTT_ADHOC::MessageInfo &info)
{
    argument.beginStructure();
    argument >> info.id >>  info.type >> info.startTime >> info.remoteUid >>  info.freeText >> info.aisleType
        >> info.appId >> info.optId >> info.appName >> info.remark;
...
Q_DECLARE_METATYPE(QT_DTT_ADHOC::FileInfo)

inline QDBusArgument &operator<<(QDBusArgument &argument, const QT_DTT_ADHOC::FileInfo &info)
{
    argument.beginStructure();
...
inline const QDBusArgument &operator>>(const QDBusArgument &argument, QT_DTT_ADHOC::FileInfo &info)
{
    argument.beginStructure();
...
Q_DECLARE_METATYPE(QT_DTT_ADHOC::AdHocMsgHeader)
inline QDBusArgument &operator<<(QDBusArgument &argument, const QT_DTT_ADHOC::AdHocMsgHeader &header)
{
    argument.beginStructure();
...
inline const QDBusArgument &operator>>(const QDBusArgument &argument, QT_DTT_ADHOC::AdHocMsgHeader &header)
{
    argument.beginStructure();
    argument >> header.opcode >> header.frameNum >> header.timeSlotNum >> header.msgLength;
    argument.endStructure();
...
inline QDataStream& operator<<(QDataStream &argument, const QT_DTT_ADHOC::AdHocMsgHeader &header)
{
    argument << header.opcode << header.frameNum << header.timeSlotNum << header.msgLength;
...
inline QDataStream& operator>>(QDataStream &argument, QT_DTT_ADHOC::AdHocMsgHeader &header)
{
    argument >> header.opcode >> header.frameNum >> header.timeSlotNum >> header.msgLength;
...
Q_DECLARE_METATYPE(QT_DTT_ADHOC::AdHocGroupInfoCfgReq)

inline QDBusArgument &operator<<(QDBusArgument &argument, const QT_DTT_ADHOC::AdHocGroupInfoCfgReq &req)
{
    argument.beginStructure();
    argument << req.header;
...
inline const QDBusArgument &operator>>(const QDBusArgument &argument, QT_DTT_ADHOC::AdHocGroupInfoCfgReq &req)
{
    argument.beginStructure();
    argument >> req.header;
    argument >> req.memberNum;
...
Q_DECLARE_METATYPE(QT_DTT_ADHOC::AdHocGroupInfoCfgRsp)

inline QDBusArgument &operator<<(QDBusArgument &argument,const QT_DTT_ADHOC::AdHocGroupInfoCfgRsp &rsp)
{
    argument.beginStructure();
    argument << rsp.header;
...
inline const QDBusArgument &operator>>(const QDBusArgument &argument, QT_DTT_ADHOC::AdHocGroupInfoCfgRsp &rsp)
{
    argument.beginStructure();
    argument >> rsp.header;
    argument >> rsp.groupId;
...
inline QDataStream& operator<<(QDataStream &argument, const QT_DTT_ADHOC::AdHocGroupInfoCfgRsp &rsp)
{
    argument << rsp.header;
    argument << rsp.groupId;
    argument << rsp.result ;
...
inline QDataStream& operator>>(QDataStream &argument, QT_DTT_ADHOC::AdHocGroupInfoCfgRsp &rsp)
{
    argument >> rsp.header;
    argument >> rsp.groupId;
    argument >> rsp.result;
...
Q_DECLARE_METATYPE(QT_DTT_ADHOC::AdHocGroupPTTPushOnReq)

inline QDBusArgument &operator<<(QDBusArgument &argument,const QT_DTT_ADHOC::AdHocGroupPTTPushOnReq &req)
{
    argument.beginStructure();
    argument << req.header;
    argument << req.pri ;
...
inline const QDBusArgument &operator>>(const QDBusArgument &argument, QT_DTT_ADHOC::AdHocGroupPTTPushOnReq &req)
{
    argument.beginStructure();
    argument >> req.header;
     argument >> req.pri ;
...
inline QDataStream &operator<<(QDataStream &argument,const QT_DTT_ADHOC::AdHocGroupPTTPushOnReq &req)
{
...
inline const QDataStream &operator>>(QDataStream &argument, QT_DTT_ADHOC::AdHocGroupPTTPushOnReq &req)
{
...
Q_DECLARE_METATYPE(QT_DTT_ADHOC::AdHocGroupPTTPushOnRsp)

inline QDBusArgument &operator<<(QDBusArgument &argument,const QT_DTT_ADHOC::AdHocGroupPTTPushOnRsp &rsp)
{
    argument.beginStructure();
    argument << rsp.header;
    argument << rsp.result ;
...
inline const QDBusArgument &operator>>(const QDBusArgument &argument, QT_DTT_ADHOC::AdHocGroupPTTPushOnRsp &rsp)
{
    argument.beginStructure();
    argument >> rsp.header;
    argument >> rsp.result;
...
inline QDataStream &operator<<(QDataStream &argument,const QT_DTT_ADHOC::AdHocGroupPTTPushOnRsp &rsp)
{
    argument << rsp.header;
    argument << rsp.result;
    argument << rsp.reserved[0];
...
inline QDataStream &operator>>(QDataStream &argument, QT_DTT_ADHOC::AdHocGroupPTTPushOnRsp &rsp)
{
    argument >> rsp.header;
    argument >> rsp.result;
    argument >> rsp.reserved[0];
...
Q_DECLARE_METATYPE(QT_DTT_ADHOC::AdHocGroupPTTReleaseReq)

inline QDBusArgument &operator<<(QDBusArgument &argument,const QT_DTT_ADHOC::AdHocGroupPTTReleaseReq &req)
{
    argument.beginStructure();
    argument << req.header;
    argument << req.groupId;
...
inline const QDBusArgument &operator>>(const QDBusArgument &argument, QT_DTT_ADHOC::AdHocGroupPTTReleaseReq &req)
{
    argument.beginStructure();
    argument >> req.header;
    argument >>  req.groupId;
...
Q_DECLARE_METATYPE(QT_DTT_ADHOC::AdHocGroupPTTStatusInd)

inline QDBusArgument &operator<<(QDBusArgument &argument,const QT_DTT_ADHOC::AdHocGroupPTTStatusInd &rsp)
{
    argument.beginStructure();
    argument << rsp.header;
    argument << rsp.status ;
...
inline const QDBusArgument &operator>>(const QDBusArgument &argument, QT_DTT_ADHOC::AdHocGroupPTTStatusInd &rsp)
{
    argument.beginStructure();
    argument >> rsp.header;
    argument >> rsp.status;
...
Q_DECLARE_METATYPE(QT_DTT_ADHOC::GroupPttPushOnRspInfo)

inline QDBusArgument &operator<<(QDBusArgument &argument,const QT_DTT_ADHOC::GroupPttPushOnRspInfo &info)
{
    argument.beginStructure();
...
inline const QDBusArgument &operator>>(const QDBusArgument &argument, QT_DTT_ADHOC::GroupPttPushOnRspInfo &info)
{
    argument.beginStructure();
    argument >> info.result ;
    argument >> info.groupId;
...
Q_DECLARE_METATYPE(QT_DTT_ADHOC::GroupPttStatusIndInfo)
inline QDBusArgument &operator<<(QDBusArgument &argument,const QT_DTT_ADHOC::GroupPttStatusIndInfo &info)
{
    argument.beginStructure();
...
inline const QDBusArgument &operator>>(const QDBusArgument &argument, QT_DTT_ADHOC::GroupPttStatusIndInfo &info)
{
    argument.beginStructure();
    argument >> info.status ;
    argument >> info.groupId;
