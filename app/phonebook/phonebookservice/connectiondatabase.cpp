...
{
    QString resPath = "/data/apps/com.sinux.phonebook/res/contacter_phonebook.ini";
...
QString ConnectionDatabase::getSetting(const QString &key)
{
    QString resPath = "/data/apps/com.sinux.phonebook/res/setting.ini";
    QSettings settings(resPath, QSettings::IniFormat);
    QTextCodec *codec = QTextCodec::codecForName("UTF-8");
    settings.setIniCodec(codec);
...
//    resPath.cdUp();
//    resPath.cd("res");
    QString resPath = "/data/apps/com.sinux.phonebook/res/group_phonebook.ini";
