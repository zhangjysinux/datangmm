 ...
 *		<tr>
 *			<td>voiceStyle</td>
 *			<td>字符串，有效值{clear, vivid, normal, plain}</td>
 *			<td>normal</td>
 *			<td>朗读风格</td>
 *			<td>clear: 清晰<br/>
 *				vivid: 生动<br/>
 ...
 *		<tr>
 *			<td>tagmode</td>
 *			<td>字符串，有效值{none,auto,vtml,ssml,s3ml}</td>
 *			<td>none</td>
 *			<td>标记处理方式</td>
 ...
 *				vtml: 处理VTML标记 <br/>
 *				ssml: 处理SSML标记 <br/> 
 *				注意: 本地端仅支持 none 和 s3ml(本地s3ml暂时只支持：segment、prosody、mark) <br/> 
 ...
 *		<tr>
 *			<td>tagmode（仅本地支持）</td>
 *			<td>字符串，有效值{none,s3ml}</td>
 *			<td>none</td>
 *			<td>标记处理方式</td>
 *			<td>none: 所有标记将会被视为文本读出，缺省值<br/>
 *				注意: s3ml暂时只支持：segment、prosody、mark <br/> 
 *				更多S3ML的详细介绍，请参照：《捷通华声iHear7.0_Embedded S3ML 标记语言使用说明》 </td> 
 *		</tr>
 *	</table>
 */
 ...
 *		<tr>
 *			<td>speedUp</td>
 *			<td>字符串，有效值{auto,0,1,2,3}</td>
 *			<td>auto</td>
 *			<td>引擎加速设置，仅v6能力支持</td>
