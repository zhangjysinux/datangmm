...
#include <QDebug>
#include <QFile>
#define DATA_PATH "/data/apps/com.sinux.phonebookadhoc
#define APP_PATH "/data/data/com.sinux.phonebookadhoc
...
int LingYun::init()
{
    ...
    init_config += QString(",authpath=%1").arg("/data/data/com.sinux.phonebookadhoc");         //授权文件所在路径，保证可写
    init_config += QString(",logfilepath=%1").arg("/data/data/com.sinux.phonebookadhoc");   //日志的路径
    ...
    initAudioOutput();
    //transToTts("adfad");
//    m_ttsSynth->FunctionFunc("tts.local.synth","/data/apps/com.sinux.phonebookadhoc/libs","/home/user/tts");
...
void LingYun::writeToFile(QString msg)
{
    ...
    file.close();
    m_enable = false;
    m_ttsSynth->FunctionFunc("tts.local.synth","/data/apps/com.sinux.phonebookadhoc/libs","/home/user");
    play();
