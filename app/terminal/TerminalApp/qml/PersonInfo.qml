                ...
                Loader {
                    ...
                    onLoaded: {
                        ...
                        if (lineHead.text == "模块数字对讲") {
                            loadButtonBox1.item.dialicon = "qrc:/main/images/icon_ppt.png"
                            loadButtonBox1.item.thirdEnable = false
                        }
                        else if (lineHead.text == "自组网" || lineHead.text == "LTE" || lineHead.text == "WIFI")
                        {
                            loadButtonBox1.item.thirdIcon = "qrc:/main/images/icon_camera.png"
                        }
                        else
                        {
                            loadButtonBox1.item.thirdEnable = false
...
//        }
        ...
        Text {
            ...
            anchors.topMargin: bluetoothShare ? 24 : 79
            height: bluetoothShare ? 30 : 32
            width: parent.width
            wrapMode: Text.Wrap
            lineHeight: 2
            horizontalAlignment: Qt.AlignHCenter
            color: "black"
            font.pixelSize: bluetoothShare ? 30 : 32
            text: ""
        }
        CButton {
            id: deletecancel
            anchors.top: message.bottom
            anchors.topMargin: bluetoothShare ? 24 : 69
            anchors.left: parent.left
            anchors.leftMargin: bluetoothShare ? 159 : 62
            width: 150
            height: 67
...
//                                  "qrc:/bluetooth/images/bluetooth_cancel.png"
        ...
        CButton {
            ...
            anchors.leftMargin: bIsEditDialog ? 175 : 80
            width: 150
            height: 67
            backgroundEnabled: true
            textColor: "#ffffff"
...
//                                  ((bIsdelete || bIsEditDialog || bIs400MHZ) ? "qrc:/history/images/suredelete.png": "qrc:/bluetooth/images/bluetooth_open.png")
            ...
            onClicked: {
                ...
                if (bIsdelete) {
                    ...
                    bIs400MHZ = false
                    pageStack.push("qrc:/qml/DigitalTalk.qml",{"bIsGroup":false,personname:m_name,"bIsGroup":false})
    ...
    Component {
        ...
        Item {
            ...
            CButton{
                ...
                height: 72
                anchors.verticalCenter: parent.verticalCenter
                iconSource: "qrc:/main/images/icon_message.png"
                backgroundEnabled: false
                onClicked: {
                    pageStack.push("qrc:/qml/Message.qml")
...
//                    qApp.openUrl(url)
            ...
            CButton{
                ...
                anchors.leftMargin: 24
                anchors.verticalCenter: parent.verticalCenter
                iconSource: "qrc:/main/images/dialed.png"
                backgroundEnabled: false
                onClicked: {
            ...
            CButton{
                ...
                width: 72
                height: 72
                visible: (dial.iconSource == "qrc:/group/images/icon_ppt.png") ? false : true
