...
CPage {
    ...
    property string networkInfo: "默认"
        ...
        CEditTitleBar {
            ...
            editRightComponent: CButton {
                ...
                onClicked: {
                    ...
                    if (!bIsFromGroupInfo && listModel.count >= 3){
...
//        }
        SearchLine {
            ...
            onSignalgetinputtext: {
                searchText = text
                bIsFinish = false
                getData.getAddGroupPersonInfo(getData.getGroupNetType(networkInfo),text,groupid)
        ...
        CEditListView {
            ...
            Component.onCompleted: {
                ...
                networkadd.append({"thenameinfo":"自组网","opacitynum":"0"})
