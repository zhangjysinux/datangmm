...
#include <QDBusError>
#include <QThread>
#include "../../phonebook/phonebookservice/contacterinterface.h"
#include "../../phonebook/phonebookservice/groupinterface.h"
#include "../../phonebook/phonebookservice/messagemanager.h"
#include "../../phonebook/phonebookservice/callhistoryinterface.h"
#include <QDateTime>
#include "../../phonebook/phonebookservice/chinesetopinyin.h"
#include "../../phonebook/phonebookservice/bluetoothinterface.h"
#include "../../phonebook/phonebookservice/backgroundsyncinterface.h"
#include "../../phonebook/phonebookservice/connection.h"
#include <QDebug>
#include <QDir>
#include <iostream>
#include <sys/resource.h>
#include <QtConcurrent/QtConcurrent>
#include "../../phonebook/phonebookservice/adaptor/downloadcontactadaptor.h"
#include "../../phonebook/phonebookservice/adaptor/muticastadaptor.h"
#include "../../phonebook/phonebookservice/adaptor/fileshareadaptor.h"
#include "../../phonebook/phonebookservice/adaptor/contactershareadaptor.h"
#define isServer 0
...
Q_DECL_EXPORT int main(int argc, char *argv[])
{
    ...
    qDebug() << "contacterServiceName:" << contacterServiceName;
//    QString ch = " dsflkgkdsth ";
//    qDebug() << "nihao ---> :" << Chinese::getPinyinFirstLetter(ch.toLocal8Bit().data());
//    qDebug() << "delete contact.db " << QFile::remove("/data/data/com.sinux.phonebook/contact.db");
//    SqlFunction::install();
//    qDebug() << "getNumbersLetter" << getNumbersLetter("234");
//    QThread::sleep(10);

    qDebug()<< "phone book start ###########################################";

    //set max files
//    rlimit limit;
//    if(getrlimit(RLIMIT_NOFILE, &limit)){
//        qDebug() << "getrlimit error";
//    }
//    qDebug() << "getrlimit" << limit.rlim_cur << limit.rlim_max;
...
//    }
//    qDebug() << "setrlimit" << limit.rlim_cur << limit.rlim_max;
...
//    qDebug() << "getrlimit" << limit.rlim_cur << limit.rlim_max;
    ...
    qDebug() << "bus create-----";
    if(!bus.registerService(contacterServiceName))
...
//        qDebug() << "bus error:" << "register backgroundtransferadaptor false";
    ...
    QObject::connect(downloadContact, SIGNAL(signalContacterDownload(ContacterList)),
                     contacter, SLOT(onContacterDownload(ContacterList)));
    QObject::connect(downloadContact, SIGNAL(signalGroupsDownload(GroupList)),
    ...
    int ret = SYBEROS::SyberosServiceCache::qApplication(argc, argv, new TerminalService_Workspace());
    db.close();
    return ret;
}
