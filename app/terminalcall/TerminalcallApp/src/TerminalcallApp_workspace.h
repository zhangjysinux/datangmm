#ifndef __TERMINALCALLAPP_WORKSPACE__
#define __TERMINALCALLAPP_WORKSPACE__
...
#include "../../PhoneCall/MyApp/src/dialinterfaceadaptor.h"
#include "../../PhoneCall/MyApp/src/tablemodel.h"

using namespace SYBEROS;

class TerminalcallApp_Workspace : public CWorkspace
{
    Q_OBJECT
...
#endif //__TERMINALCALLAPP_WORKSPACE__
