...
//        }
        ...
        Item {
            ...
            Text {
                id: name1
                height: 40
                text: csDbus.getVideoValue("phoneNum")
        ...
        Row {
            ...
            CButton {
                ...
                onClicked: {
                    csDbus.setVidEnabledChanged(network, csDbus.getVideoValue("handlerId"),false)
                    //csDbus.setVidInputChanged(network, csDbus.getVideoValue("handlerId"))
                }
            }
            CButton {
                id: button2
        ...
        CButton {
            ...
            onClicked: {
                csDbus.hold(csDbus.getVideoValue("handlerId"), true)
