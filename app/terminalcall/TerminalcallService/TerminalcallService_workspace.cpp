...
TerminalcallService_Workspace::TerminalcallService_Workspace()
    : CWorkspace()
{
...
void TerminalcallService_Workspace::setDisplayState(bool state)
{
    if (state) {
...
void TerminalcallService_Workspace::onCallHandlerIdChanged(QString dialingNumber, QString handlerId)
{
...
void TerminalcallService_Workspace::onStartMake(int net, QString phoneNum)
{
    SYBEROS::CServiceApplication * app = static_cast<SYBEROS::CServiceApplication *>(QCoreApplication::instance());
...
void TerminalcallService_Workspace::onStartInCommingVideo(QString callId, QString remoteIpAddr)
{
    SYBEROS::CServiceApplication * app = static_cast<SYBEROS::CServiceApplication *>(QCoreApplication::instance());
...
void TerminalcallService_Workspace::onLaunchComplete(Option option, const QStringList& params)
{
    Q_UNUSED(params)
