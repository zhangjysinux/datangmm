...
inline QDataStream &operator<<(QDataStream &argument,const QT_DTT::AdHocGroupPTTPushOnReq &req)
{
...
inline const QDataStream &operator>>(QDataStream &argument, QT_DTT::AdHocGroupPTTPushOnReq &req)
{
...
inline QDataStream &operator<<(QDataStream &argument,const QT_DTT::AdHocGroupPTTPushOnRsp &rsp)
{
    argument << rsp.header;
    argument << rsp.result;
    argument << rsp.reserved[0];
...
inline QDataStream &operator>>(QDataStream &argument, QT_DTT::AdHocGroupPTTPushOnRsp &rsp)
{
    argument >> rsp.header;
    argument >> rsp.result;
    argument >> rsp.reserved[0];
