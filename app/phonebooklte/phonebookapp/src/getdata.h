...
public:
    ...
    Q_INVOKABLE void updateLocalInfo(QString name, QString title,QString snNum, QString bluetooth);
    ...
    Q_INVOKABLE void updateContacter(QString name, QString title, QString num, QString photopath);
    ...
    Q_INVOKABLE void onSetPropertyType();
