...
CPage {
    ...
    property int type//0:real 1:file send
...
//                }
        ...
        SearchLine {
            ...
            onSignalgetinputtext: {
                //listmodel.clear()
                searchText = text
                realtimeVideo.getAddPersonInfo(text)
            }
        }
        ListModel {
            id: listmodel
            ...
            delegate: CEditListViewDelegate {
                ...
                Item {
                    ...
                    MouseArea {
                        anchors.fill: item
                        onClicked: {
                            pageStack.push("qrc:/qml/PersonInfo.qml",{"fromText":"network","userId":id,"contactertype":contacterType,parentSource2:parentSource,sendtype:type})
                        }
                    }
                }
            }
