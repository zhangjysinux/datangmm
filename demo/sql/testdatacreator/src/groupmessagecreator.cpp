...
void GroupMessageCreator::createImageData(QSqlQuery &query, int id)
{
    ...
    query.addBindValue(QString("file:///data/data/com.sinux.phonebook/messagefiles/image.jpg"));
...
void GroupMessageCreator::createVideoData(QSqlQuery &query, int id)
{
    ...
    query.addBindValue(QString("file:///data/data/com.sinux.phonebook/messagefiles/video.mp4"));
