...
ln -s ../voipBodyVideoService.service  %{buildroot}/usr/lib/systemd/user/user-session.target.wants/voipBodyVideoService.service	

%clean

%files
%defattr(-,system,system,-)
%{_bindir}/voipBodyVideoService	
