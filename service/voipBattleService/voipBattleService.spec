...
ln -s ../voipBattleService.service  %{buildroot}/usr/lib/systemd/user/user-session.target.wants/voipBattleService.service

%clean

%files
%defattr(-,system,system,-)
%{_bindir}/voipBattleService
