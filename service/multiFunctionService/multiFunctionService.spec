...
ln -s ../multiFunctionService.service  %{buildroot}/usr/lib/systemd/user/user-session.target.wants/multiFunctionService.service

%clean

%files
%defattr(-,system,system,-)
%{_bindir}/multiFunctionService
