...
ln -s ../bluetoothModuleService.service  %{buildroot}/usr/lib/systemd/user/user-session.target.wants/bluetoothModuleService.service

%clean

%files
%defattr(-,system,system,-)
%{_bindir}/bluetoothModuleService
